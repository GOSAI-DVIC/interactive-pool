...
export function hauteurLessonInsideShow(sketch, f) {
    ...
    if(firstAudio == true && audioMedia.checkIfAudioEnded() == true) {
        firstAudio = false;
        audioMedia.playSound("./platform/home/apps/triangles_lesson/assets/11_hauteurs_def_suite.wav")
    }
...
function onEnter() {
    ...
    triangle = new Triangle(b1, b2, b3)
    audioMedia.playSound("./platform/home/apps/triangles_lesson/assets/10_hauteurs_def.wav")
}
