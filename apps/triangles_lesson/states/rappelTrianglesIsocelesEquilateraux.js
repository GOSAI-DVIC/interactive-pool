...
export function rappelTrianglesIsocelesEquilaterauxShow(sketch, f, balls) {
    ...
    if (firstAudio && audioMedia.checkIfAudioEnded()) {
        firstAudio = false;
        audioMedia.playSound("./platform/home/apps/triangles_lesson/assets/18_rappel_triangles_isocèle_equilateral.wav")
    }
    if (!firstAudio && audioMedia.checkIfAudioEnded()) {
...
function onEnter() {
    ...
    audioMedia.playSound("./platform/home/apps/triangles_lesson/assets/17_rappel_triangles_particuliers.wav")
}
