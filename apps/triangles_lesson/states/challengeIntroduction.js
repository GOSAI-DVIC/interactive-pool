...
export function challengeIntroductionShow(sketch, f, balls) {
  ...
  if (firstAudio && audioMedia.checkIfAudioEnded()) {
    firstAudio = false;
    secondAudio = true;
    audioMedia.playSound("./platform/home/apps/triangles_lesson/assets/26_perte_de_point_par_erreur_defi_intro.wav")
  }
  if (secondAudio && audioMedia.checkIfAudioEnded()) {
    secondAudio = false;
    thirdAudio = true;
    audioMedia.playSound("./platform/home/apps/triangles_lesson/assets/27_start_defi_place_palet.wav")
  }
