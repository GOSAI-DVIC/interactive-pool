...
export function __challengeState__Show(sketch, f, balls, round) {
    ...
    // REPRENDRE ICI : faire le code pour checker si le triangle est isocele
    // si oui, goDefaultNextStep = true
    // si non : trigger solution. //audio times out + 39_voici_la_solution.wav
