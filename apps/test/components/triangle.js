...
export class Triangle {
    ...
    show(sketch) {
        ...
        stroke(this.color)
        strokeWeight(5)
        line(this.triangle[0].x,this.triangle[0].y,this.triangle[1].x,this.triangle[1].y)
        line(this.triangle[0].x,this.triangle[0].y,this.triangle[2].x,this.triangle[2].y)
        line(this.triangle[2].x,this.triangle[2].y,this.triangle[1].x,this.triangle[1].y)
        pop();
    }
    ...
    showAngle(sketch,f){
        ...
        textAlign(CENTER, CENTER);
        rotate( radians(angle_text) );
        text(this.angle_a+"°", 0,0);
        pop();
    ...
    showMediane(sketch) {
        ...
        stroke(255,255,0)
        strokeWeight(5)
        line(this.triangle[0].x,this.triangle[0].y,this.returnXCenter(1,2),this.returnYCenter(1, 2))
        line(this.triangle[1].x,this.triangle[1].y,this.returnXCenter(0,2),this.returnYCenter(0, 2))
        line(this.triangle[2].x,this.triangle[2].y,this.returnXCenter(1,0),this.returnYCenter(1, 0))
        pop();
    }
    ...
    showPerpendicularBisector(sketch) {
        ...
        strokeWeight(5)
        fill(255,0,255);
        circle(this.circumcenter.x,this.circumcenter.y,15);
        noFill();
        stroke(255,0,255)
        line(this.extremity1_1.x,this.extremity1_1.y, this.extremity1_2.x,this.extremity1_2.y)
        line(this.extremity2_1.x,this.extremity2_1.y, this.extremity2_2.x,this.extremity2_2.y)
        line(this.extremity3_1.x,this.extremity3_1.y, this.extremity3_2.x,this.extremity3_2.y)
    ...
    showCircumCircle(sketch) {
      ...
      strokeWeight(8)
      fill(0)
      circle(this.circumcenter.x,this.circumcenter.y,(this.distanceOf2Balls(this.circumcenter,this.triangle[0]))*2)
      pop();
    }
}